...
<body>
	...
	<div class="page-wraper"> 
                                ...
                                <div class="contact-nav">
                                     ...
                                     <div class="contact-nav-form p-a30">
                                        ...
                                        <div class="text-center">
                                            <h4 class="font-weight-600">&copy;  2022 7xtheme</h4> 
                                        </div>                                                                    			
                                     </div>
                                </div> 
                            </div>                               
        ...
        <div class="page-content">
            ...
            <!-- ABOUT COMPANY START -->
            <div class="section-full  mobile-page-padding p-t80 p-b30 site-bg-dark bg-repeat square_shape2 bg-moving" style="background-image:url(images/background/bg-6.png)">
                <div class="container">
                    <!-- TITLE START -->
            ...
            <div class="section-full mobile-page-padding our-service-wrap  p-b50  square_shape2">
				<div class="section-content">
                    <div class="Service-half-top p-t80  site-bg-dark bg-moving" style="background-image:url(images/background/bg-6.png)" >
                        <div class="container">
                            <!-- TITLE START -->
            ...
            <!-- OUR BLOG START -->
            <div class="section-full mobile-page-padding latest-blog-wrap p-t80 p-b30 square_shape1" style="background-image:url(images/background/bg5.jpg)">
                                    ...
                                    <div class="mt-post-info p-a30">
                                        <div class="post-overlay-position">
                                            <div class="mt-post-meta ">
                                                <ul>
                                                    <li class="post-date"><strong class="site-text-primary">14</strong> <span>April 2022</span></li>
                                ...
                                <div class="mt-box blog-post latest-blog-3 date-style-1 bg-white m-b30">
                                    ...
                                    <div class="mt-post-info p-a30">
                                        <div class="post-overlay-position">
                                            <div class="mt-post-meta ">
                                                <ul>
                                                    <li class="post-date"><strong class="site-text-primary">16</strong> <span>Feb 2022</span></li>
                                                    <li class="post-author">By <a href="javascript:;">Admin</a> </li>
                                                    <li class="post-comment"><a href="javascript:;">2 comment</a> </li>
                                                </ul>
                                            </div>                                        
                                ...
                                <div class="mt-box blog-post latest-blog-3 date-style-1 bg-white m-b30">
                                    ...
                                    <div class="mt-post-info p-a30">
                                        <div class="post-overlay-position">
                                            <div class="mt-post-meta ">
                                                <ul>
                                                    <li class="post-date"><strong class="site-text-primary">18</strong> <span>Jan 2022</span></li>
                                                    <li class="post-author">By <a href="javascript:;">Admin</a> </li>
                                                    <li class="post-comment"><a href="javascript:;">2 comment</a> </li>
                                                </ul>
                                            </div>                                        
                ...
                <div class="container">
                    <div class="row">
                        <div class="mt-footer-bot-center">
                            <span class="copyrights-text">© 2022 Your Company. Designed By 7xtheme.</span>
                        </div>
                    </div>
                </div>
            </div>
